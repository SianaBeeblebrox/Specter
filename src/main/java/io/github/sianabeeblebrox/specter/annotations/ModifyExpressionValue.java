 ...
 * <pre>
 * &#64;ModifyExpressionValue(method = "print", target = &#64;Target(value = "INVOKE", target = "Ljava/lang/Object;toString()Ljava/lang/String;"))
 ...
 * <pre>
 * &#64;ModifyExpressionValue(method = "print", target = &#64;Target(value = "GETFIELD", target = "Ljava/lang/Integer;MAX_VALUE:I"))
 ...
 * <pre>
 * &#64;ModifyExpressionValue(method = "print", target = &#64;Target(value = "NEW", target = "java/lang/String"))
 * public String modifyValue(String value) {
 *     return value.toUpperCase();
 * }
 * </pre>
