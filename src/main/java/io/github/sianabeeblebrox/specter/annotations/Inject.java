 ...
 * If you want to change them you need to use {@link Local}.<br>
 * <br>
 ...
 * <pre>
 * &#64;Inject(method = "print(Ljava/lang/String;)V", target = &#64;Target("HEAD"))
 ...
 * <pre>
 * &#64;Inject(method = "print", target = &#64;Target(value = "INVOKE", target = "...", shift = Target.Shift.BEFORE))
 ...
 * @see Target
 * @see Slice
 * @see <a href="https://github.com/Lenni0451/ClassTransform/wiki/Inject">GitHub Wiki</a>
 */
